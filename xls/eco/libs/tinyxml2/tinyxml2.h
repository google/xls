...
// TODO(xls-eco): This library is used by gxl_parser for legacy GXL file format.
// Will be deprecated along with ir2gxl.py and ir2nx.py in favor of
// xls_ir_to_cytoscape.cc which generates Cytoscape JSON directly.
