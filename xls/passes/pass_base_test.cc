      ...
      proto, proto_testing::Partially(proto_testing::EqualsProto(R"pb(
        ...
        pass_metrics {
          ...
          nested_results {
            ...
            nested_results { pass_name: "level_up" changed: 1 pass_number: 2 }
            nested_results { pass_name: "dce" changed: 1 pass_number: 3 }
            nested_results { pass_name: "level_up" changed: 1 pass_number: 4 }
            nested_results { pass_name: "dce" changed: 1 pass_number: 5 }
            nested_results { pass_name: "level_up" changed: 1 pass_number: 6 }
            nested_results { pass_name: "dce" changed: 1 pass_number: 7 }
            nested_results { pass_name: "level_up" changed: 1 pass_number: 9 }
            nested_results { pass_name: "dce" changed: 1 pass_number: 10 }
          }
        }
      )pb")));
}
  ...
  EXPECT_THAT(
      proto, proto_testing::Partially(proto_testing::EqualsProto(R"pb(
        ...
        pass_metrics {
          ...
          changed: 1
          pass_number: 0
          nested_results { pass_name: "level_up" changed: 1 pass_number: 1 }
          nested_results { pass_name: "dce" changed: 1 pass_number: 2 }
          nested_results { pass_name: "level_up" changed: 1 pass_number: 3 }
          nested_results { pass_name: "dce" changed: 1 pass_number: 4 }
          nested_results { pass_name: "level_up" changed: 1 pass_number: 5 }
          nested_results { pass_name: "dce" changed: 1 pass_number: 6 }
          nested_results { pass_name: "level_up" changed: 1 pass_number: 7 }
          nested_results { pass_name: "dce" changed: 1 pass_number: 8 }
        }
      )pb")));
  EXPECT_THAT(f->return_value(), m::Literal(UBits(4, 64)));
}
      ...
      proto, proto_testing::Partially(proto_testing::EqualsProto(R"pb(
        ...
        pass_metrics {
          ...
          nested_results {
            ...
            nested_results { pass_name: "level_up" changed: 1 pass_number: 5 }
            nested_results { pass_name: "dce" changed: 1 pass_number: 6 }
            nested_results { pass_name: "level_up" changed: 1 pass_number: 8 }
            nested_results { pass_name: "dce" changed: 1 pass_number: 9 }
            nested_results { pass_name: "level_up" changed: 1 pass_number: 11 }
            nested_results { pass_name: "dce" changed: 1 pass_number: 12 }
            nested_results { pass_name: "level_up" changed: 1 pass_number: 14 }
            nested_results { pass_name: "dce" changed: 1 pass_number: 15 }
          }
        }
      )pb")));
}
  ...
  EXPECT_THAT(
      proto, proto_testing::Partially(proto_testing::EqualsProto(R"pb(
        ...
        pass_metrics {
          ...
          changed: 1
          pass_number: 0
          nested_results { pass_name: "node_adder_0" changed: 0 pass_number: 1 }
          nested_results {
