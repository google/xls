...
#ifndef XLS_PASSES_PROC_STATE_ELIMINATION_PASS_H_
#define XLS_PASSES_PROC_STATE_ELIMINATION_PASS_H_
...
class ProcStateEliminationPass : public OptimizationProcPass {
 public:
  static constexpr std::string_view kName = "proc_state_elimination";
  ProcStateEliminationPass()
      : OptimizationProcPass(kName, "Proc State Elimination") {}
  ~ProcStateEliminationPass() override = default;
...
#endif  // XLS_PASSES_PROC_STATE_ELIMINATION_PASS_H_
