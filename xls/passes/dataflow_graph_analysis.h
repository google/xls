...
class DataflowGraphAnalysis {
 public:
  static absl::StatusOr<DataflowGraphAnalysis> Create(
      FunctionBase* f, const QueryEngine* query_engine = nullptr);
 ...
 private:
  explicit DataflowGraphAnalysis(std::vector<Node*> topo_sort_nodes,
