...
class NewProcInliningPassTest : public IrTestBase {
 protected:
  NewProcInliningPassTest() = default;
  ...
  absl::StatusOr<bool> Run(Package* p,
    ...
    XLS_ASSIGN_OR_RETURN(bool changed,
                         NewProcInliningPass().Run(p, options, &results));
  ...
  absl::StatusOr<Proc*> MakeLoopbackProc(absl::string_view name, Channel* in,
    ...
    return b.Build(send, b.GetUniqueStateParam());
  }
  ...
  absl::StatusOr<Proc*> MakeDelayedLoopbackProc(absl::string_view name,
    ...
    ProcBuilder b(name,
                  ...
                  "tkn", "st", p);
    BValue cnt = b.TupleIndex(b.GetUniqueStateParam(), 0);
    BValue data = b.TupleIndex(b.GetUniqueStateParam(), 1);
  ...
  absl::StatusOr<Proc*> MakePassThroughProc(absl::string_view name,
    ...
    return b.Build(send_b, b.GetUniqueStateParam());
  }
  ...
  absl::StatusOr<Proc*> MakeLoopingAccumulatorProc(absl::string_view name,
    ...
    ProcBuilder b(
        ...
        "tkn", "st", p);
    BValue i = b.TupleIndex(b.GetUniqueStateParam(), 0, loc, "i");
    BValue accum = b.TupleIndex(b.GetUniqueStateParam(), 1, loc, "accum");
    ...
    return b.Build(send, b.Tuple({next_i, next_accum}));
  }
  ...
  absl::StatusOr<Proc*> MakeSumAndDifferenceProc(absl::string_view name,
    ...
    return b.Build(send_x_minus_y, b.GetUniqueStateParam());
  }
  ...
  absl::StatusOr<Proc*> MakeSumProc(absl::string_view name, Channel* x_in,
    ...
    return b.Build(send_out, b.GetUniqueStateParam());
  }
  ...
  absl::StatusOr<Proc*> MakeTupleAccumulator(absl::string_view name,
    ...
    ProcBuilder b(
        ...
        "tkn", "st", p);
    BValue cnt = b.TupleIndex(b.GetUniqueStateParam(), 0);
    BValue x_accum = b.TupleIndex(b.GetUniqueStateParam(), 1);
    BValue y_accum = b.TupleIndex(b.GetUniqueStateParam(), 2);
...
TEST_F(NewProcInliningPassTest, NestedProcsWithSingleValue) {
  // Nested procs where the inner proc does a trivial arithmetic operation.
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
  XLS_ASSERT_OK_AND_ASSIGN(
...
TEST_F(NewProcInliningPassTest, NestedProcsWithConditionalSingleValueSend) {
  ...
  XLS_ASSERT_OK(ab.Build(send_out, ab.GetUniqueStateParam()));
...
TEST_F(NewProcInliningPassTest, NestedProcDelayedPassThrough) {
...
TEST_F(NewProcInliningPassTest, InputPlusDelayedInput) {
...
TEST_F(NewProcInliningPassTest, NestedProcsTrivialInnerLoop) {
...

  {
    ...
    //    if(!st): send(42)
    //    st = !st
    ProcBuilder bb("B", Value(UBits(1, 1)), "tkn", "st", p.get());
    BValue rcv_from_a =
        bb.ReceiveIf(a_to_b, bb.GetTokenParam(), bb.GetUniqueStateParam());
    BValue send_to_a =
        bb.SendIf(b_to_a, bb.TupleIndex(rcv_from_a, 0),
                  bb.Not(bb.GetUniqueStateParam()), bb.Literal(UBits(42, 32)));
    XLS_ASSERT_OK(bb.Build(send_to_a, bb.Not(bb.GetUniqueStateParam())));
  }
...
TEST_F(NewProcInliningPassTest, NestedProcsIota) {
  ...
  {
    ProcBuilder bb("B", Value(UBits(42, 32)), "tkn", "st", p.get());
    BValue send_to_a =
        bb.Send(b_to_a, bb.GetTokenParam(), bb.GetUniqueStateParam());
    XLS_ASSERT_OK(bb.Build(
        send_to_a, bb.Add(bb.GetUniqueStateParam(), bb.Literal(UBits(1, 32)))));
  }
...
TEST_F(NewProcInliningPassTest, NestedProcsOddIota) {
  // Output only nested procs where the inner proc just implements iota
...

  {
    ...
    BValue send_to_a = bb.SendIf(
        b_to_a, bb.GetTokenParam(),
        bb.BitSlice(bb.GetUniqueStateParam(), /*start=*/0, /*width=*/1),
        bb.GetUniqueStateParam());
    XLS_ASSERT_OK(bb.Build(
        send_to_a, bb.Add(bb.GetUniqueStateParam(), bb.Literal(UBits(1, 32)))));
  }
...
TEST_F(NewProcInliningPassTest, SynchronizedNestedProcs) {
...

  {
    ...
    BValue rcv_in =
        ab.ReceiveIf(ch_in, ab.GetTokenParam(), ab.GetUniqueStateParam());
    BValue send_to_b =
        ab.SendIf(a_to_b, ab.TupleIndex(rcv_in, 0), ab.GetUniqueStateParam(),
                  ab.TupleIndex(rcv_in, 1));
    BValue rcv_from_b =
        ab.ReceiveIf(b_to_a, send_to_b, ab.GetUniqueStateParam());
    BValue send_out =
        ab.SendIf(ch_out, ab.TupleIndex(rcv_from_b, 0),
                  ab.GetUniqueStateParam(), ab.TupleIndex(rcv_from_b, 1));
    XLS_ASSERT_OK(ab.Build(send_out, ab.Not(ab.GetUniqueStateParam())));
  }

  {
    ...
    BValue rcv_from_a =
        bb.ReceiveIf(a_to_b, bb.GetTokenParam(), bb.GetUniqueStateParam());
    BValue send_to_a = bb.SendIf(
        b_to_a, bb.TupleIndex(rcv_from_a, 0), bb.GetUniqueStateParam(),
...
TEST_F(NewProcInliningPassTest, NestedProcsNontrivialInnerLoop) {
  // Nested procs where the inner proc loops more than once for each received
                    ...
                    .status());
  {
    ...
    //     x += i
    //   snd(x)
    ProcBuilder bb("B", Value::Tuple({Value(UBits(0, 2)), Value(UBits(0, 32))}),
                   "tkn", "st", p.get());
    BValue cnt = bb.TupleIndex(bb.GetUniqueStateParam(), 0);
...
TEST_F(NewProcInliningPassTest, DoubleNestedProcsPassThrough) {
  // Nested procs where the inner proc passes through the value.
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
  XLS_ASSERT_OK_AND_ASSIGN(
...
TEST_F(NewProcInliningPassTest, SequentialNestedProcsPassThrough) {
...
TEST_F(NewProcInliningPassTest, SequentialNestedLoopingProcsWithState) {
...
TEST_F(NewProcInliningPassTest, SequentialNestedProcsWithLoops) {
...
TEST_F(NewProcInliningPassTest, DoubleNestedLoops) {
                    ...
                    .status());
  {
    ...
    //      send(b_to_a, z)
    //    cnt = !cnt
    ProcBuilder bb("B", Value::Tuple({Value(UBits(1, 1)), Value(UBits(0, 32))}),
                   "tkn", "st", p.get());
    BValue cnt = bb.TupleIndex(bb.GetUniqueStateParam(), 0);
    BValue accum = bb.TupleIndex(bb.GetUniqueStateParam(), 1);
...

  {
    ...
    //     send(c_to_b, accum)
    //   cnt += 1
    ProcBuilder cb("C", Value::Tuple({Value(UBits(0, 2)), Value(UBits(0, 32))}),
                   "tkn", "st", p.get());
    BValue cnt = cb.TupleIndex(cb.GetUniqueStateParam(), 0);
    BValue accum = cb.TupleIndex(cb.GetUniqueStateParam(), 1);
...
TEST_F(NewProcInliningPassTest, MultiIO) {
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
  XLS_ASSERT_OK_AND_ASSIGN(
      Channel * x_in,
...

  {
    ...
    XLS_ASSERT_OK(ab.Build(send_diff, ab.GetUniqueStateParam()));
  }
...
TEST_F(NewProcInliningPassTest, InlinedProcsWithExternalStreamingIO) {
...

  {
    ...
    BValue send_sum = ab.Send(x_plus_y_out, ab.TupleIndex(rcv_sum, 0),
                              ab.TupleIndex(rcv_sum, 1));
    XLS_ASSERT_OK(ab.Build(send_sum, ab.GetUniqueStateParam()));
  }
...
TEST_F(NewProcInliningPassTest, InlinedProcsWithExternalSingleValueIO) {
...
TEST_F(NewProcInliningPassTest, SingleValueAndStreamingChannels) {
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
  XLS_ASSERT_OK_AND_ASSIGN(
      Channel * x_in,
...
TEST_F(NewProcInliningPassTest, TriangleProcNetwork) {
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
  XLS_ASSERT_OK_AND_ASSIGN(
      Channel * ch_in,
...

  {
    ...
    XLS_ASSERT_OK(bb.Build(send_to_c, bb.GetUniqueStateParam()));
  }

  {
    ProcBuilder cb("C", Value::Tuple({}), "tkn", "st", p.get());
    ...
    XLS_ASSERT_OK(cb.Build(send, cb.GetUniqueStateParam()));
  }
...
TEST_F(NewProcInliningPassTest, DelayedReceive) {
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
  XLS_ASSERT_OK_AND_ASSIGN(
      Channel * ch_in,
...
TEST_F(NewProcInliningPassTest, DataLoss) {
  ...
  //      send(out, y)
  //    st = !st
  ProcBuilder ab("A", Value(UBits(1, 1)), "tkn", "st", p.get());
  BValue rcv_in = ab.Receive(ch_in, ab.GetTokenParam());
  BValue in_data = ab.TupleIndex(rcv_in, 1);
  BValue send_to_b = ab.Send(a_to_b, ab.TupleIndex(rcv_in, 0), in_data);

  BValue rcv_from_b = ab.ReceiveIf(b_to_a, send_to_b, ab.GetUniqueStateParam());
  BValue send_out =
      ab.SendIf(ch_out, ab.TupleIndex(rcv_from_b, 0), ab.GetUniqueStateParam(),
                ab.TupleIndex(rcv_from_b, 1));
  XLS_ASSERT_OK(ab.Build(send_out, ab.Not(ab.GetUniqueStateParam())));
...
TEST_F(NewProcInliningPassTest, DataLossDueToReceiveNotActivated) {
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
  XLS_ASSERT_OK_AND_ASSIGN(
      Channel * ch_in,
...

  {
    ...
    BValue send0 =
        ab.SendIf(a_to_b0, ab.TupleIndex(rcv, 0), ab.GetUniqueStateParam(),
...
TEST_F(NewProcInliningPassTest, SingleValueChannelWithVariantElements1) {
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
...

  {
    ...
    XLS_ASSERT_OK(ab.Build(send_result1, ab.GetUniqueStateParam()));
  }
...
TEST_F(NewProcInliningPassTest, SingleValueChannelWithVariantElements2) {
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
  Type* u64 = p->GetBitsType(64);
  Type* u32_u64 = p->GetTupleType({u32, u64});
...
TEST_F(NewProcInliningPassTest, SingleValueChannelWithVariantElements3) {
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
...
TEST_F(NewProcInliningPassTest, SingleValueChannelWithVariantElements4) {
  auto p = CreatePackage();
  Type* u32 = p->GetBitsType(32);
  Type* u32_u32 = p->GetTupleType({u32, u32});
  XLS_ASSERT_OK_AND_ASSIGN(
...
TEST_F(NewProcInliningPassTest, TokenFanIn) {
...
TEST_F(NewProcInliningPassTest, TokenFanOut) {
...
TEST_F(NewProcInliningPassTest, RandomProcNetworks) {
  ...
  for (int sample = 0; sample < kNumberSamples; ++sample) {
    ...
    // Top level builder.
    ProcBuilder b("top", Value::Tuple({}), "tkn", "st", p.get());
    ...
    XLS_ASSERT_OK_AND_ASSIGN(Proc * top,
                             b.Build(send_out, b.GetUniqueStateParam()));
...
TEST_F(NewProcInliningPassTest, DataDependencyWithoutTokenDependency) {
  ...
  XLS_ASSERT_OK(ab.Build(ab.AfterAll({send_out, ab.TupleIndex(rcv_from_b, 0)}),
                         ab.GetUniqueStateParam()));
