...
class LazyTernaryQueryEngineTest : public IrTestBase {
 protected:
...
TEST_F(LazyTernaryQueryEngineTest, Uge) {
...
TEST_F(LazyTernaryQueryEngineTest, Ugt) {
...
TEST_F(LazyTernaryQueryEngineTest, Ule) {
...
TEST_F(LazyTernaryQueryEngineTest, Ult) {
...
TEST_F(LazyTernaryQueryEngineTest, Ne) {
...
TEST_F(LazyTernaryQueryEngineTest, Eq) {
  auto make_ne = [](BValue lhs, BValue rhs, FunctionBuilder* fb) {
    fb->Eq(lhs, rhs);
  };
...
TEST_F(LazyTernaryQueryEngineTest, Gate) {
...
TEST_F(LazyTernaryQueryEngineTest, GateCompound) {
...
TEST_F(LazyTernaryQueryEngineTest, Sel) {
  // No default.
  {
    auto p = CreatePackage();
    FunctionBuilder fb(TestName(), p.get());
...
TEST_F(LazyTernaryQueryEngineTest, OneHotSel) {
  // bits
  {
    auto p = CreatePackage();
    FunctionBuilder fb(TestName(), p.get());
...
TEST_F(LazyTernaryQueryEngineTest, OneHotSelOfOneHot) {
  // bits
...
TEST_F(LazyTernaryQueryEngineTest, PrioritySel) {
  // bits
  constexpr std::string_view kP1Value = "0b0000001X";
  constexpr std::string_view kP2Value = "0b00001X10";
  constexpr std::string_view kP3Value = "0b001X1000";
...
TEST_F(LazyTernaryQueryEngineTest, PrioritySelWithOneHot) {
  // bits
  constexpr std::string_view kP1Value = "0b0000001X";
  constexpr std::string_view kP2Value = "0b00001X10";
  constexpr std::string_view kP3Value = "0b001X1000";
...
TEST_F(LazyTernaryQueryEngineTest, PrioritySelWithKnownBit) {
  // bits
...
TEST_F(LazyTernaryQueryEngineTest, Identity) {
  {
...
TEST_F(LazyTernaryQueryEngineTest, EmptyCompoundIdentity) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexJoins) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexTooLargeGetsBottom) {
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexLiteralResult) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexExact) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexZeroBitValue) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
...
TEST_F(LazyTernaryQueryEngineTest, ArrayOperationResult) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexOOB) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexFullyKnown) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexFullyKnownIsNegOne63Bit) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexFullyKnownIsNegOne64Bit) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexFullyKnownIsNegOne128Bit) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexClamps) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexMultiDimensionalConstantResult) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexMultiDimensionalSomeValuesKnown) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexMultiDimensionalSomeValuesKnown2) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayIndexMultiDimensionalSomeValues3) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
...
TEST_F(LazyTernaryQueryEngineTest, MultipleArrayIndex) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayUpdate) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  // bits[12][3]
  XLS_ASSERT_OK_AND_ASSIGN(
...
TEST_F(LazyTernaryQueryEngineTest, ArrayUpdateZeroLengthIndex) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  // bits[12][3]
  XLS_ASSERT_OK_AND_ASSIGN(
...
TEST_F(LazyTernaryQueryEngineTest, ArrayUpdateExact) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayUpdateExactOOB) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      BValue array,
...
TEST_F(LazyTernaryQueryEngineTest, ArrayUpdateSometimesOOB) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  // bits[12][3]
  XLS_ASSERT_OK_AND_ASSIGN(
...
TEST_F(LazyTernaryQueryEngineTest, ArrayUpdateOOB) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  // bits[12][3]
  XLS_ASSERT_OK_AND_ASSIGN(
...
TEST_F(LazyTernaryQueryEngineTest, ArrayUpdateMultiDimensional) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
  XLS_ASSERT_OK_AND_ASSIGN(
      Value array_val,
...
TEST_F(LazyTernaryQueryEngineTest, TupleIndex) {
  auto package = CreatePackage();
  FunctionBuilder fb(TestName(), package.get());
...
TEST_F(LazyTernaryQueryEngineTest, TupleIndexIndex) {
  auto p = CreatePackage();
  FunctionBuilder fb(TestName(), p.get());
  XLS_ASSERT_OK_AND_ASSIGN(
...
TEST_F(LazyTernaryQueryEngineTest, Recalculate) {
  auto p = CreatePackage();
  FunctionBuilder fb(TestName(), p.get());
...
TEST_F(LazyTernaryQueryEngineTest, PrioritySelectJoin) {
  auto p = CreatePackage();
  FunctionBuilder fb(TestName(), p.get());
...
TEST_F(LazyTernaryQueryEngineTest, Givens) {
  auto p = CreatePackage();
  FunctionBuilder fb(TestName(), p.get());
  BValue sel = fb.Param("sel", p->GetBitsType(1));
  BValue foo = fb.Param("foo", p->GetBitsType(8));
  BValue bar = fb.Param("bar", p->GetBitsType(8));
  BValue v = fb.PrioritySelect(sel, {foo}, bar);
  XLS_ASSERT_OK_AND_ASSIGN(Function * f, fb.Build());

  absl::flat_hash_map<Node*, LeafTypeTree<TernaryVector>> test_givens;
  test_givens.emplace(
      foo.node(),
      LeafTypeTree<TernaryVector>(foo.node()->GetType(),
                                  StringToTernaryVector("0b111111XX").value()));
  LazyTernaryQueryEngine query_engine;
  ASSERT_THAT(query_engine.PopulateWithGivens(f, test_givens),
              IsOkAndHolds(ReachedFixpoint::Changed));
  EXPECT_THAT(query_engine.ToString(v.node()), "0bXXXX_XXXX");
  ASSERT_THAT(query_engine.AddGiven(
                  bar.node(), LeafTypeTree<TernaryVector>(
                                  bar.node()->GetType(),
                                  StringToTernaryVector("0bXX111111").value())),
              IsOkAndHolds(ReachedFixpoint::Changed));
  EXPECT_THAT(query_engine.ToString(v.node()), "0bXX11_11XX");
  ASSERT_EQ(query_engine.RemoveGiven(v.node()), ReachedFixpoint::Unchanged);
  EXPECT_THAT(query_engine.ToString(v.node()), "0bXX11_11XX");
...
void BM_ArrayIndexExactShallow(benchmark::State& state) {
  ...
  BValue result = fb.ArrayIndex(
      array, {fb.Param("selector", p->GetBitsType(state.range(0)))});
  XLS_ASSERT_OK_AND_ASSIGN(auto* f, fb.Build());
  LazyTernaryQueryEngine tqe;
  for (auto _ : state) {
    XLS_ASSERT_OK(tqe.Populate(f).status());
    tqe.ForceRecompute(result.node());
    std::optional<SharedTernaryTree> t = tqe.GetTernary(result.node());
...
void BM_ArrayIndexExactDeep(benchmark::State& state) {
  ...
  BValue result = fb.ArrayIndex(array, selectors);
  XLS_ASSERT_OK_AND_ASSIGN(auto* f, fb.Build());
  LazyTernaryQueryEngine tqe;
  for (auto _ : state) {
    XLS_ASSERT_OK(tqe.Populate(f).status());
...
void CheckEngineConsistency(FuzzPackageWithArgs a) {
  CheckTernaryEngineConsistency<LazyTernaryQueryEngine>(a);
}

FUZZ_TEST(LazyTernaryQueryEngineFuzzTest, CheckEngineConsistency)
    .WithDomains(
