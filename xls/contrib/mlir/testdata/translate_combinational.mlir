// RUN: xls_translate --mlir-xls-to-xls %s --main-function=combinational -- --delay_model=asap7 --generator=combinational 2>&1 | FileCheck %s --dump-input-filter=all --check-prefix=XLS
// RUN: xls_translate --mlir-xls-to-verilog %s --main-function=combinational -- --delay_model=asap7 --generator=combinational 2>&1 | FileCheck %s --dump-input-filter=all --check-prefix=VERILOG-COMB
