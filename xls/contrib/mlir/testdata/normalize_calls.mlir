...
// CHECK: func.func private @dot_product_dot_product_fixed_test(!xls.array<4xi32>, !xls.array<4xi32>) -> i32 attributes {xls.linkage = {{.*}}<@dot_product : "dot_product_fixed_test">}
// CHECK: xls.import_dslx_file_package "xls/contrib/mlir/testdata/foo/dot_product.x" as @dot_product_0
// CHECK: func.func private @dot_product_dot_product_fixed_test_1(!xls.array<4xi32>, !xls.array<4xi32>) -> i32 attributes {xls.linkage = {{.*}}<@dot_product_0 : "dot_product_fixed_test">}

// CHECK-LABEL:   func.func @simple_call(
// CHECK-SAME:        %[[VAL_0:.*]]: !xls.array<4xi32>, %[[VAL_1:.*]]: !xls.array<4xi32>
...
func.func @simple_call(%arg0: !xls.array<4xi32>, %arg1: !xls.array<4xi32>) -> i32 {
  %0 = xls.call_dslx "xls/contrib/mlir/testdata/i32/dot_product.x":
    "dot_product_fixed_test"(%arg0, %arg1) : (!xls.array<4xi32>, !xls.array<4xi32>) -> i32
  ...
  %2 = xls.call_dslx "xls/contrib/mlir/testdata/foo/dot_product.x":
    ...
    (%arg0, %arg1) : (!xls.array<4xi32>, !xls.array<4xi32>) -> i32
  return %0 : i32
}
