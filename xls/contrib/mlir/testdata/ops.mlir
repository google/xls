...
// CHECK-LABEL: sel_pow2
func.func @sel_pow2(%arg0: i16, %arg1: i32, %arg2: i32) -> i32 {
  %0 = xls.sel %arg0 in [%arg1, %arg2] : (i16, [i32, i32]) -> i32
  // CHECK: xls.sel
  return %0 : i32
}

// CHECK-LABEL: sel_nonpow2
func.func @sel_nonpow2(%arg0: i16, %arg1: i32, %arg2: i32, %arg3: i32) -> i32 {
  %0 = xls.sel %arg0 in [%arg1, %arg2, %arg3] else %arg1 : (i16, [i32, i32, i32], i32) -> i32
  // CHECK: xls.sel
  return %0 : i32
}
...
func.func @multidim_array(%arg0: tensor<3xi32>, %arg1: tensor<3xi32>) -> !xls.array<2 x tensor<3 x i32>> {
  // CHECK: xls.array
  %0 = xls.array %arg0, %arg1 : (tensor<3xi32>, tensor<3xi32>) -> !xls.array<2 x tensor<3 x i32>>
  return %0 : !xls.array<2 x tensor<3 x i32>>
}

// -----
func.func @mismatch_num_elements_array(%arg0: i32, %arg1: i32) -> !xls.array<2 x 3 x i32> {
  // expected-error@+1 {{mismatch between op element counts}}
...
// CHECK-LABEL: xls.block @child_for_inst
// CHECK-LABEL: xls.block @block_instantiate_test
// CHECK: xls.block_instantiate "inst" @child_for_inst(%in) : (i32) -> (i32)
xls.block @child_for_inst(%a : i32) -> (%out : i32) {
  xls.block_output %a : i32
}
xls.block @block_instantiate_test(%in : i32) -> (%out : i32) {
  %result = xls.block_instantiate "inst" @child_for_inst(%in) : (i32) -> (i32)
  xls.block_output %result : i32
}

// -----

// CHECK-LABEL: xls.block @child_multi
// CHECK-LABEL: xls.block @block_instantiate_multi
// CHECK: xls.block_instantiate "multi_inst" @child_multi(%a, %b) : (i32, i16) -> (i32, i16)
xls.block @child_multi(%x : i32, %y : i16) -> (%p : i32, %q : i16) {
  xls.block_output %x, %y : i32, i16
}
xls.block @block_instantiate_multi(%a : i32, %b : i16) -> (%r : i32, %s : i16) {
  %p, %q = xls.block_instantiate "multi_inst" @child_multi(%a, %b) : (i32, i16) -> (i32, i16)
  xls.block_output %p, %q : i32, i16
}
