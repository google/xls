...
absl::Status Translator::GenerateIR_SharedFunctionStub(
  ...
  auto found_shared_function = shared_function_impls_.find(funcdecl);

  XLSCC_CHECK_NE(found_shared_function, shared_function_impls_.end(), loc);
  const GeneratedFunction& shared_function = *found_shared_function->second;
