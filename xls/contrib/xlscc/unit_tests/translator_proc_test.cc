...
TEST_P(TranslatorProcTest, IOProcMuxInSubroutine) {
  const std::string content = R"(
...
TEST_P(TranslatorProcTest, ForPipelinedSerialInSubroutine) {
  const std::string content = R"(
    void sub(int& a) {
      #pragma hls_pipeline_init_interval 1
      for(long i=1;i<=4;++i) {
...
TEST_P(TranslatorProcTest, ForPipelinedNestedInSubroutine) {
  const std::string content = R"(
    void sub(int& a) {
      #pragma hls_pipeline_init_interval 1
      for(short i=0;i<2;++i) {
...
TEST_P(TranslatorProcTest, ForPipelinedPipelinedInSubroutineWithDynamicExit) {
  const std::string content = R"(
    void sub(int& a) {
      #pragma hls_pipeline_init_interval 1
  ...
  absl::flat_hash_map<std::string, std::list<xls::Value>> inputs;
  inputs["in"] = {xls::Value(xls::SBits(1, 32)), xls::Value(xls::SBits(2, 32)),
                  xls::Value(xls::SBits(3, 32))};

  {
    absl::flat_hash_map<std::string, std::list<xls::Value>> outputs;
    outputs["out"] = {xls::Value(xls::SBits(27, 32)),
                      xls::Value(xls::SBits(18, 32)),
                      xls::Value(xls::SBits(27, 32))};
...
TEST_P(TranslatorProcTest, ForPipelinedIOInBodySubroutine3) {
  ...
  if (generate_new_fsm_) {
    absl::flat_hash_map<std::string, std::list<xls::Value>> inputs;
    inputs["in1"] = {xls::Value(xls::SBits(10, 32)),
                     xls::Value(xls::SBits(20, 32))};
    inputs["in2"] = {xls::Value(xls::SBits(2, 32)),
                     xls::Value(xls::SBits(5, 32))};

    absl::flat_hash_map<std::string, std::list<xls::Value>> outputs;
    outputs["out"] = {xls::Value(xls::SBits(10 + 20 + 2 + 5, 32))};
...
TEST_P(TranslatorProcTest, IODefaultStrictness) {
  ...
  for (xls::Channel* channel : package_->channels()) {
    ...
    EXPECT_EQ(absl::down_cast<xls::StreamingChannel*>(channel)->strictness(),
...
TEST_P(TranslatorProcTest, PipelinedLoopASAPDataDependency) {
  ...
  if (generate_new_fsm_) {
    ASSERT_THAT(ret.status(), absl_testing::StatusIs(
                                  absl::StatusCode::kUnimplemented,
                                  testing::HasSubstr("scheduling options")));
  } else {
    ASSERT_THAT(ret.status(),
                absl_testing::StatusIs(
                    absl::StatusCode::kUnimplemented,
...
TEST_P(TranslatorProcTest, MultiBlock) {
  const std::string content = R"(
...
TEST_P(TranslatorProcTest, MultiBlock2) {
  const std::string content = R"(
    #pragma hls_design block
    void block_a(__xls_channel<int, __xls_channel_dir_In>& in,
                 __xls_channel<int, __xls_channel_dir_InOut>& xfer) {
...
TEST_P(TranslatorProcTest, MultiBlock3) {
  const std::string content = R"(
    #pragma hls_design block
    void block_a(__xls_channel<int, __xls_channel_dir_In>& in,
                 __xls_channel<int, __xls_channel_dir_InOut>& xfer) {
...
TEST_P(TranslatorProcTest, MultiBlockSharedFunc) {
  const std::string content = R"(
    int shared(int x) {
      return x;
    }
...
TEST_P(TranslatorProcTest, MultiBlockSubSub) {
  const std::string content = R"(
    #pragma hls_design block
...
TEST_P(TranslatorProcTest, MultiBlockDirectIn) {
  const std::string content = R"(
    #pragma hls_design block
    void block_a(__xls_channel<int, __xls_channel_dir_In>& in,
                 __xls_channel<int, __xls_channel_dir_InOut>& xfer) {
...
TEST_P(TranslatorProcTest, MultiBlockMultipleChannelCombos) {
  const std::string content = R"(
    #pragma hls_design block
    void block_a(__xls_channel<int, __xls_channel_dir_In>& in,
                 __xls_channel<int, __xls_channel_dir_InOut>& xfer) {
...
TEST_P(TranslatorProcTest, ForUnrolledNestedInferred) {
  const std::string content = R"(
    #pragma hls_top
    void foo(__xls_channel<int>& in,
             __xls_channel<int>& out) {
...
TEST_P(TranslatorProcTest, StaticInSubroutine) {
  const std::string content = R"(
    ...
    void foo(__xls_channel<int>& in,
              __xls_channel<int>& out) {
      const int ctrl = read_it_with_offset(in);
  ...
  inputs["in"] = {xls::Value(xls::SBits(55, 32)),
                  xls::Value(xls::SBits(100, 32)),
                  xls::Value(xls::SBits(150, 32))};

  absl::flat_hash_map<std::string, std::list<xls::Value>> outputs;
  outputs["out"] = {xls::Value(xls::SBits(56, 32)),
                    xls::Value(xls::SBits(102, 32)),
...
TEST_P(TranslatorProcTest, MaskedSubroutineWithIO2) {
  const std::string content = R"(
        #define on_reset(f)             \
        {                             \
          thread_local bool once = f; \
          (void)once;                 \
        }
...
TEST_P(TranslatorProcTest, PassthroughFeedbackOrder) {
  const std::string content = R"(
       class Block {
        public:
         __xls_channel<int, __xls_channel_dir_In>& in;
  ...
  absl::flat_hash_map<std::string, std::list<xls::Value>> inputs;
  inputs["in"] = {xls::Value(xls::SBits(34, 32))};

  {
    absl::flat_hash_map<std::string, std::list<xls::Value>> outputs;
    outputs["out"] = {
        xls::Value(xls::SBits(34, 32)), xls::Value(xls::SBits(34, 32)),
        xls::Value(xls::SBits(34, 32)), xls::Value(xls::SBits(10, 32)),
        xls::Value(xls::SBits(10, 32)), xls::Value(xls::SBits(10, 32))};
    ProcTest(content, /*block_spec=*/std::nullopt, inputs, outputs,
             /* min_ticks = */ 1,
             /* max_ticks = */ 100,
...
TEST_F(TranslatorProcTest_NewFSM_Mutex,
       MergeMutuallyExclusiveOpsWithDependencyInSharedFunction) {
  const std::string content = R"(
        [[hls_shared_function]]
        int read_it(__xls_channel<int, __xls_channel_dir_In>& data_in) {
          return data_in.read();
        }
       ...
       class Block {
        public:
         ...
         #pragma hls_top
         void Run() {
           const int a = read_it(data_in);
           if (a == 1) {
             __xlscc_activation_barrier</*conditional=*/true>();
             const int b = read_it(data_in);
             data_out.write(a + b);
           }
         }
        };)";
...
TEST_F(TranslatorProcTest_NewFSM_Mutex,
       MergeMutuallyExclusiveOpsWithDependencyInSharedFunction2) {
  const std::string content = R"(
        [[hls_shared_function]]
        int read_it(bool mult,
                    __xls_channel<int, __xls_channel_dir_In>& data_in) {
          int ret = 0;
          [[hls_pipeline_init_interval(1)]]
          for (int i=0;i<4;++i) {
            ret += (mult ? i : 1) * data_in.read();
          }
          return ret;
        }
       ...
       class Block {
        public:
         ...
         #pragma hls_top
         void Run() {
           const int a = read_it(false, data_in);
           if (a == 1) {
             __xlscc_activation_barrier</*conditional=*/true>();
             const int b = read_it(true, data_in);
             data_out.write(a + b);
           }
         }
        };)";
...

  {
    ...
    inputs["data_in"] = {
        ...
        xls::Value(xls::SBits(0, 32)), xls::Value(xls::SBits(0, 32)),
        xls::Value(xls::SBits(3, 32)), xls::Value(xls::SBits(6, 32)),
        xls::Value(xls::SBits(7, 32)), xls::Value(xls::SBits(2, 32)),
        // Iteration
        xls::Value(xls::SBits(1, 32)), xls::Value(xls::SBits(2, 32)),
        xls::Value(xls::SBits(3, 32)), xls::Value(xls::SBits(4, 32)),
        // Iteration
        xls::Value(xls::SBits(0, 32)), xls::Value(xls::SBits(0, 32)),
        xls::Value(xls::SBits(1, 32)), xls::Value(xls::SBits(0, 32)),
        xls::Value(xls::SBits(5, 32)), xls::Value(xls::SBits(8, 32)),
        xls::Value(xls::SBits(1, 32)), xls::Value(xls::SBits(1, 32))};

    absl::flat_hash_map<std::string, std::list<xls::Value>> outputs;
    outputs["data_out"] = {
        xls::Value(xls::SBits(1 + 0 * 3 + 1 * 6 + 2 * 7 + 3 * 2, 32)),
        xls::Value(xls::SBits(1 + 0 * 5 + 1 * 8 + 2 * 1 + 3 * 1, 32))};
    ProcTest(content, /*block_spec=*/std::nullopt, inputs, outputs,
             /*min_ticks=*/8 + 4 + 8);
  }
}
...
TEST_F(TranslatorProcTest_NewFSM_Mutex,
       MergeMutuallyExclusiveOpsWithDependencyInSharedFunction3) {
  const std::string content = R"(
        [[hls_shared_function]]
        int read_it(bool mult,
                    __xls_channel<int, __xls_channel_dir_In>& data_in) {
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedure) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
         return b + a * in.read();
       }
...

  {
    ...
    absl::flat_hash_map<std::string, std::list<xls::Value>> outputs;
    outputs["out"] = {
        xls::Value(xls::SBits(1 + 2 * 3 + 5 * 5, 32)),
        xls::Value(xls::SBits(1 + 2 * 3 + 5 * 5 + 2 * 10 + 5 * 20, 32))};
    ProcTest(content, /*block_spec=*/std::nullopt, inputs, outputs,
             /*min_ticks=*/2);
  }
}

TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureMethod) {
  const std::string content = R"(
       class Block {
        public:
         __xls_channel<int, __xls_channel_dir_In>& in;
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureBarrierPropagate) {
  const std::string content = R"(
       [[hls_propagate_barrier_scopes]]
       [[hls_shared_function]]
       long fn(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
  ...
  ASSERT_THAT(ret.status(),
              absl_testing::StatusIs(absl::StatusCode::kUnimplemented,
                                     testing::HasSubstr("barrier")));
}

TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureStoreInputs) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(long a) {
         long ret = 0;
...

  {
    ...
    absl::flat_hash_map<std::string, std::list<xls::Value>> outputs;
    outputs["out"] = {
        xls::Value(xls::SBits(1 + 3 + 0 * 3 + 1 * 3 + 2 * 3 + 3 * 3, 32)),
        xls::Value(xls::SBits(1 + 5 + 0 * 5 + 1 * 5 + 2 * 5 + 3 * 5, 32))};
    ProcTest(content, /*block_spec=*/std::nullopt, inputs, outputs,
             /*min_ticks=*/4);
  }
}

TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureCallsSubroutine) {
  const std::string content = R"(
       long fn_inner(long a, __xls_channel<int, __xls_channel_dir_In>& in) {
         const int r = in.read();
         return a * r;
       }
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureConditionalBarrier) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
         return b + a * in.read();
...

  {
    ...
    absl::flat_hash_map<std::string, std::list<xls::Value>> outputs;
    outputs["out"] = {xls::Value(xls::SBits(1 + 2 * 3, 32)),
                      xls::Value(xls::SBits(1 + 2 * 3 + 2 * 10 + 5 * 20, 32))};
    ProcTest(content, /*block_spec=*/std::nullopt, inputs, outputs,
             /*min_ticks=*/2);
  }
}

TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureConditional) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
         const int r = in.read();
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureConditional2) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
         __xlscc_activation_barrier</*conditional=*/false>();
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureBarrierWithin) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
         const int x = in.read();
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedurePipelinedLoopWithin) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(long a, __xls_channel<int, __xls_channel_dir_In>& in) {
         long ret = a;
         [[hls_pipeline_init_interval(1)]]
         for (int i=0;i<4;++i) {
            ret += in.read();
...

  {
    ...
    inputs["in"] = {
        xls::Value(xls::SBits(3, 32)),  xls::Value(xls::SBits(1, 32)),
        xls::Value(xls::SBits(10, 32)), xls::Value(xls::SBits(5, 32)),
        xls::Value(xls::SBits(2, 32)),  xls::Value(xls::SBits(2, 32)),
        xls::Value(xls::SBits(2, 32)),  xls::Value(xls::SBits(2, 32))};

    absl::flat_hash_map<std::string, std::list<xls::Value>> outputs;
    outputs["out"] = {
        xls::Value(xls::SBits(1 + 2 + 3 + 1 + 10 + 5, 32)),
        xls::Value(xls::SBits(1 + 2 + 3 + 1 + 10 + 5 + 2 + 2 * 4, 32))};
    ProcTest(content, /*block_spec=*/std::nullopt, inputs, outputs,
             /*min_ticks=*/2);
  }
}

TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedurePipelinedLoopWithout) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(__xls_channel<int, __xls_channel_dir_In>& in) {
         long ret = in.read();
         return ret;
       }
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureCallsSharedProcedure) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn_inner(long a, __xls_channel<int, __xls_channel_dir_In>& in) {
         const int r = in.read();
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureCallsSharedProcedure2) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn_inner(long a, __xls_channel<int, __xls_channel_dir_In>& in) {
         const int r = in.read();
       ...
       long fn_middle(long a, __xls_channel<int, __xls_channel_dir_In>& in) {
        return fn_inner(a, in);
       }
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureCompilationError) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
         // Generate an error
  ...
  ASSERT_THAT(ret.status(),
              absl_testing::StatusIs(absl::StatusCode::kUnimplemented,
                                     testing::HasSubstr("marker")));
}

TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureInactive) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fn(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
         long ret = b;
...
TEST_F(TranslatorProcTest_NewFSM_Mutex, SharedProcedureInactive2) {
  const std::string content = R"(
       [[hls_shared_function]]
       long fnA_proc(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
         long ret = b;
         [[hls_pipeline_init_interval(1)]]
         for (int i=0;i<10;++i) {
          if (i != 5) {
       ...
       long fnA(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
        long ret = fnA_proc(a, b, in);
        __xlscc_activation_barrier</*conditional=*/false>();
        return ret;
       }

       [[hls_shared_function]]
       long fnB_proc(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
         long ret = b;
         [[hls_pipeline_init_interval(1)]]
         for (int i=0;i<10;++i) {
          if (i != 5) {
       ...
       long fnB(long a, long b, __xls_channel<int, __xls_channel_dir_In>& in) {
        long ret = fnB_proc(a, b, in);
        __xlscc_activation_barrier</*conditional=*/false>();
        return ret;
       }
  ...
  for (const std::unique_ptr<xls::Proc>& proc : package_->procs()) {
    for (const xls::Node* node : proc->nodes()) {
      if (node->op() == xls::Op::kReceive &&
          node->As<xls::Receive>()->channel_name() == "in") {
        ++receive_count;
      }
    }
  }
...
TEST_P(TranslatorProcTest_NewFSMOnly, SharedProcedureTemplated) {
  const std::string content = R"(
       template<int N>
       [[hls_shared_function]]
       long fn(__xls_channel<int, __xls_channel_dir_In>& in) {
