...
def main():
  ...
  parser.add_argument(
      "-D", "--define", help="Define a preprocessor symbol.", action="append", default=[])
  parser.add_argument(
      "--channel_in", help="Define an input channel.", action="append", default=[])
  parser.add_argument(
      "--channel_out", help="Define an output channel.", action="append", default=[])
  parser.add_argument(
      "-N",
      "--package_name",
      help="Package name.",
  ...
  translator = xlscc_translator.Translator(args.package_name, hls_types_by_name, args.channel_in, args.channel_out)
