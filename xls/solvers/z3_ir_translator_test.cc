...
fn f() -> bits[32] {
  ...
  element_0: (bits[32], bits[32]) = multiarray_index(array_update.8, indices=[literal.1])
  tuple_index.10: bits[32] = tuple_index(element_0, index=0)
  tuple_index.11: bits[32] = tuple_index(element_0, index=1)
  multiarray_index.12: (bits[32], bits[32]) = multiarray_index(array_update.8, indices=[literal.2])
...
fn f() -> bits[32] {
  ...
  element_0: (bits[32][2], bits[32][2]) = multiarray_index(array_update.8, indices=[literal.1])
  ...
  multiarray_index.16: (bits[32][2], bits[32][2]) = multiarray_index(array_update.8, indices=[literal.2])
...
fn f() -> bits[32] {
  ...
  element_0: bits[32] = multiarray_index(array_update.8, indices=[literal.1])
  multiarray_index.10: bits[32] = multiarray_index(array_update.8, indices=[literal.2])
}
)";
