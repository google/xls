...
// FIXME: Use default parameter value when fixed (https://github.com/google/xls/issues/1425)
// SIZE_W:u32 = {std::clog2(SIZE + u32:1)}
pub struct HashTableReadReq<
    KEY_W: u32, SIZE: u32, SIZE_W:u32
> {
...
pub struct HashTableWriteReq<
    KEY_W: u32, VALUE_W: u32, SIZE: u32, SIZE_W:u32
> {
    num_entries_log2: uN[SIZE_W],  // number of HashTable entries used in the runtime
    key: uN[KEY_W],
    value: uN[VALUE_W],
