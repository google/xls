...
pub proc CompressBlockEncoder<
    ...
    MIN_SEQ_LEN: u32,              // !
    LITERALS_BUFFER_AXI_ADDR: u32, // !
    SEQUENCE_BUFFER_AXI_ADDR: u32, // !
...
> {
    ...
    config(
        ...
        // input/output
        input_mem_rd_req_s: chan<MemReaderReq> out,
        input_mem_rd_resp_r: chan<MemReaderResp> in,

        // match finder
        mf_buf_mem_rd_req_s: chan<MemReaderReq> out,
        ...
        let (n_mf_buf_mem_rd_req_s, n_mf_buf_mem_rd_req_r) = chan<MemReaderReq, CHANNEL_DEPTH>[2]("n_mf_buf_rd_req");
        let (n_mf_buf_mem_rd_resp_s, n_mf_buf_mem_rd_resp_r) = chan<MemReaderResp, CHANNEL_DEPTH>[2]("n_mf_buf_rd_resp");
        // literals encoder
        ...
        spawn match_finder::MatchFinder<
            ADDR_W, DATA_W, HT_SIZE, HB_SIZE, MIN_SEQ_LEN, DATA_W_LOG2,
            HT_KEY_W, HT_VALUE_W, HT_SIZE_W,
            HB_DATA_W, HB_OFFSET_W,
        >(
            mf_req_r, mf_resp_s,
            input_mem_rd_req_s, input_mem_rd_resp_r,
            mf_buf_mem_wr_req_s, mf_buf_mem_wr_data_s, mf_buf_mem_wr_resp_r,
        ...
        (
            n_mf_buf_mem_rd_req_r, n_mf_buf_mem_rd_resp_s,
            mf_buf_mem_rd_req_s, mf_buf_mem_rd_resp_r,
        );
        ...
        spawn sequence_encoder::SequenceEncoder<
            ADDR_W, DATA_W, FSE_TABLE_RAM_ADDR_W,
            FSE_CTABLE_RAM_DATA_W, FSE_CTABLE_RAM_NUM_PARTITIONS,
            FSE_TTABLE_RAM_DATA_W, FSE_TTABLE_RAM_NUM_PARTITIONS,
            BITSTREAM_BUFFER_W
        >(
            se_req_r, se_resp_s,
    ...
    next(state: ()) {
        ...
        let tok = send(tok, mf_req_s, MfReq {
            ...
            zstd_params: MfParams {
                num_entries_log2: std::clog2(HT_SIZE) as uN[HT_SIZE_W]
            }
        });
