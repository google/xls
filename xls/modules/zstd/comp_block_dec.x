...
pub proc CompressBlockDecoder<
    ...
    SEQ_FSE_MAX_ACCURACY_LOG: u32 = {common::FSE_MAX_ACCURACY_LOG},
...
const TEST_SEQ_FSE_MAX_ACCURACY_LOG = common::TEST_FSE_MAX_ACCURACY_LOG;
const TEST_SEQ_FSE_RAM_SIZE = u32:1 << TEST_SEQ_FSE_MAX_ACCURACY_LOG;
...
proc CompressBlockDecoderTest {
    ...
    config(terminator: chan<bool> out) {
        ...
        let (_lit_buf_ctrl_s, lit_buf_ctrl_r) = chan<LiteralsBufCtrl>("lit_buf_ctrl");
        let (lit_buf_out_s, _lit_buf_out_r) = chan<SequenceExecutorPacket>("lit_buf_out");
    ...
    next(state: ()) {
        ...
        let tok = unroll_for!(test_i, tok): (u32, token) in u32[7]:[u32:0, u32:1, u32:2, u32:3, u32:4, u32:5, u32:6] {
