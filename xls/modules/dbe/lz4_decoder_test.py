...
from dbe import TokMK, TokCP, TokLT, Mark, Token, MarkedByte
...
async def do_comparison_test(
        dut,
        test_in: Sequence[Token], expected_out: Sequence[MarkedByte],
    ...
    expected_out_bd = list(
        DslxPlainData8.from_markedbyte(b).as_binary() for b in expected_out)
