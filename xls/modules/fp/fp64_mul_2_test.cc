...
#include "xls/modules/fp/fp64_mul_2_jit_wrapper.h"
...
// here as well.
static double ComputeExpected(fp::Fp64Mul2* jit_wrapper, Float2x64 input) {
...
static double ComputeActual(fp::Fp64Mul2* jit_wrapper, Float2x64 input) {
