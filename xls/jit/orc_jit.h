...
class OrcJit : public LlvmCompiler {
 public:
  ...
  // Loads object code into the current JIT dylib. This can be used to load
  // object code generated by the AOT compiler.
  absl::Status LoadObjectCode(absl::Span<const uint8_t> object_code);
