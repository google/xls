; The following SMT-LIB verifies that a 12-bit multiplier is equivalent
...
(define-fun m0_11 () (_ BitVec 1) (bvand x11 y0))
(define-fun m0 () (_ BitVec 12) (concat m0_11 m0_10 m0_9 m0_8 m0_7 m0_6 m0_5 m0_4 m0_3 m0_2 m0_1 m0_0))
...
(define-fun m1_11 () (_ BitVec 1) (bvand x10 y1))
(define-fun m1 () (_ BitVec 12) (concat m1_11 m1_10 m1_9 m1_8 m1_7 m1_6 m1_5 m1_4 m1_3 m1_2 m1_1 #b0))
...
(define-fun m2_11 () (_ BitVec 1) (bvand x9 y2))
(define-fun m2 () (_ BitVec 12) (concat m2_11 m2_10 m2_9 m2_8 m2_7 m2_6 m2_5 m2_4 m2_3 m2_2 #b00))
...
(define-fun m3_11 () (_ BitVec 1) (bvand x8 y3))
(define-fun m3 () (_ BitVec 12) (concat m3_11 m3_10 m3_9 m3_8 m3_7 m3_6 m3_5 m3_4 m3_3 #b000))
...
(define-fun m4_11 () (_ BitVec 1) (bvand x7 y4))
(define-fun m4 () (_ BitVec 12) (concat m4_11 m4_10 m4_9 m4_8 m4_7 m4_6 m4_5 m4_4 #b0000))
...
(define-fun m5_11 () (_ BitVec 1) (bvand x6 y5))
(define-fun m5 () (_ BitVec 12) (concat m5_11 m5_10 m5_9 m5_8 m5_7 m5_6 m5_5 #b00000))
...
(define-fun m6_11 () (_ BitVec 1) (bvand x5 y6))
(define-fun m6 () (_ BitVec 12) (concat m6_11 m6_10 m6_9 m6_8 m6_7 m6_6 #b000000))
...
(define-fun m7_11 () (_ BitVec 1) (bvand x4 y7))
(define-fun m7 () (_ BitVec 12) (concat m7_11 m7_10 m7_9 m7_8 m7_7 #b0000000))
...
(define-fun m8_11 () (_ BitVec 1) (bvand x3 y8))
(define-fun m8 () (_ BitVec 12) (concat m8_11 m8_10 m8_9 m8_8 #b00000000))
...
(define-fun m9_11 () (_ BitVec 1) (bvand x2 y9))
(define-fun m9 () (_ BitVec 12) (concat m9_11 m9_10 m9_9 #b000000000))

; Multiply x by y10, shifting x bits accordingly
(define-fun m10_10 () (_ BitVec 1) (bvand x0 y10))
(define-fun m10_11 () (_ BitVec 1) (bvand x1 y10))
(define-fun m10 () (_ BitVec 12) (concat m10_11 m10_10 #b0000000000))

; Multiply x by y11, shifting x bits accordingly
(define-fun m11_11 () (_ BitVec 1) (bvand x0 y11))
(define-fun m11 () (_ BitVec 12) (concat m11_11 #b00000000000))

; Add all m bit-vectors to create mul
(define-fun mul () (_ BitVec 12) (bvadd m11 m10 m9 m8 m7 m6 m5 m4 m3 m2 m1 m0))
