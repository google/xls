 ...
 public:
  ...
  absl::Status RunSynthesis(const CompileRequest* request,
    ...
    if (!synthesis_target_.empty()) {
      ...
      std::string yosys_cmd = BuildYosysCmds(
          request, verilog_path, synth_json_path, synth_verilog_path);
  ...
  absl::Status RunNextPNR(const CompileRequest* request,
                          ...
                          const std::filesystem::path& synth_json_path) {
