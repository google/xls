...
def append_xls_dslx_verilog_generated_files(args, basename, codegen_args):
    """Returns a dictionary of arguments appended with filenames generated by the 'xls_dslx_verilog' rule.
    ...
    Returns:
      Returns a dictionary of arguments appended with filenames generated by the 'xls_dslx_verilog' rule.
    """
    args = append_xls_dslx_ir_generated_files(args, basename)
    args = append_xls_ir_opt_ir_generated_files(args, basename)
    args = append_xls_ir_verilog_generated_files(args, basename, codegen_args)
    return args

def get_xls_dslx_verilog_generated_files(args, codegen_args):
    """Returns a list of filenames generated by the 'xls_dslx_verilog' rule found in 'args'.
    ...
    Returns:
      Returns a list of filenames generated by the 'xls_dslx_verilog' rule found in 'args'.
    """
    return (get_xls_dslx_ir_generated_files(args) +
            get_xls_ir_opt_ir_generated_files(args) +
            get_xls_ir_verilog_generated_files(args, codegen_args))
