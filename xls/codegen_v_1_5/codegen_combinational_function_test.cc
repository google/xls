...
constexpr char kTestName[] = "codegen_combinational_function_test";
...
class CodegenCombinationalFunctionTest : public verilog::VerilogTestBase {
 protected:
  absl::StatusOr<verilog::CodegenResult> GenerateCombinationalModule(
      FunctionBase* top, const verilog::CodegenOptions& codegen_options) {
    Package* package = top->package();
    XLS_RETURN_IF_ERROR(package->SetTop(top));
    return Codegen(package, codegen_options, SchedulingOptions(),
                   /*delay_estimator=*/nullptr);
  }

  verilog::CodegenOptions codegen_options() {
    return verilog::VerilogTestBase::codegen_options().generate_combinational(
        true);
  }
};

TEST_P(CodegenCombinationalFunctionTest, RrotToText) {
...
TEST_P(CodegenCombinationalFunctionTest, RandomExpression) {
...
TEST_P(CodegenCombinationalFunctionTest, ReturnsLiteral) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  ...
  verilog::ModuleSimulator simulator =
      NewModuleSimulator(result.verilog_text, result.signature);
  EXPECT_THAT(
      simulator.RunAndReturnSingleOutput(verilog::ModuleSimulator::BitsMap()),
      IsOkAndHolds(UBits(123, 8)));
}

TEST_P(CodegenCombinationalFunctionTest, ReturnsTupleLiteral) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
...
TEST_P(CodegenCombinationalFunctionTest, ReturnsEmptyTuple) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
...
TEST_P(CodegenCombinationalFunctionTest, PassesEmptyTuple) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
...
TEST_P(CodegenCombinationalFunctionTest, TakesEmptyTuple) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", u8);
...
TEST_P(CodegenCombinationalFunctionTest, ReturnsParam) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  fb.Param("a", u8);
...
TEST_P(CodegenCombinationalFunctionTest,
       CombinationalExpressionWhichRequiresNamedIntermediate) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", u8);
...
TEST_P(CodegenCombinationalFunctionTest, ExpressionsOfTuples) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
...
TEST_P(CodegenCombinationalFunctionTest, TupleLiterals) {
  std::string text = R"(
...
TEST_P(CodegenCombinationalFunctionTest, ArrayLiteral) {
  std::string text = R"(
...
TEST_P(CodegenCombinationalFunctionTest, OneHot) {
  std::string text = R"(
package OneHot
...
TEST_P(CodegenCombinationalFunctionTest, OneHotSelect) {
  std::string text = R"(
...
TEST_P(CodegenCombinationalFunctionTest, OneHotSelectNonBits) {
  std::string text = R"(
package OneHotSelect
...
TEST_P(CodegenCombinationalFunctionTest, PrioritySelect) {
  std::string text = R"(
...
TEST_P(CodegenCombinationalFunctionTest, PrioritySelectMultipleAreMerged) {
  std::string text = R"(
package PrioritySelect
...
TEST_P(CodegenCombinationalFunctionTest, PrioritySelectWithAndWithoutDefault) {
...
TEST_P(CodegenCombinationalFunctionTest, PrioritySelectOneHot) {
  std::string text = R"(
...
TEST_P(CodegenCombinationalFunctionTest, PrioritySelectArray) {
  std::string text = R"(
...
TEST_P(CodegenCombinationalFunctionTest, PrioritySelectArrayOneHot) {
  std::string text = R"(
...
TEST_P(CodegenCombinationalFunctionTest, PrioritySelectNonBits) {
...
TEST_P(CodegenCombinationalFunctionTest, PrioritySelectMixedBitsAndNonBits) {
  constexpr std::string_view text = R"(
package PrioritySelect
...
TEST_P(CodegenCombinationalFunctionTest, UncommonParameterTypes) {
  std::string text = R"(
...
top fn main(a: bits[32],
  ...
  XLS_ASSERT_OK_AND_ASSIGN(std::unique_ptr<Package> codegen_package,
                           ClonePackage(package.get()));
  ASSERT_TRUE(codegen_package->GetTop().has_value());
  XLS_ASSERT_OK_AND_ASSIGN(
      auto result, GenerateCombinationalModule(*codegen_package->GetTop(),
                                               codegen_options()));
  ExpectVerilogEqualToGoldenFile(GoldenFilePath(kTestName, kTestdataPath),
                                 result.verilog_text);
  ...
  ASSERT_TRUE(package->GetTop().value()->IsFunction());
  Function* fn = package->GetTop().value()->AsFunctionOrDie();
...
TEST_P(CodegenCombinationalFunctionTest, ArrayIndexWithBoundsCheck) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  ...
  XLS_ASSERT_OK_AND_ASSIGN(verilog::ModuleTestbenchThread * tbt,
                           tb->CreateThreadDrivingAllInputs(
                               "main", /*default_value=*/verilog::ZeroOrX::kX));
  verilog::SequentialBlock& seq = tbt->MainBlock();
...
TEST_P(CodegenCombinationalFunctionTest, ArrayIndexWithoutBoundsCheck) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  Type* array_u8 = package.GetArrayType(3, u8);
...
TEST_P(CodegenCombinationalFunctionTest, TwoDArray) {
...
TEST_P(CodegenCombinationalFunctionTest, ReturnTwoDArray) {
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdateBitElements) {
  std::string text = R"(
package ArrayUpdate
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdateArrayElements) {
  std::string text = R"(
package ArrayUpdate
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdateTupleElements) {
  std::string text = R"(
package ArrayUpdate
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdateTupleWithArrayElements) {
  std::string text = R"(
package ArrayUpdate
...
TEST_P(CodegenCombinationalFunctionTest, BuildComplicatedType) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
...
TEST_P(CodegenCombinationalFunctionTest, ArrayShapedSel) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
...
TEST_P(CodegenCombinationalFunctionTest, ArrayShapedSelNoDefault) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
...
TEST_P(CodegenCombinationalFunctionTest, ArrayShapedOneHotSelect) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
...
TEST_P(CodegenCombinationalFunctionTest, ArrayConcatArrayOfBits) {
  Package package(TestBaseName());
...
TEST_P(CodegenCombinationalFunctionTest, ArrayConcatArrayOfBitsMixedOperands) {
  Package package(TestBaseName());
...
TEST_P(CodegenCombinationalFunctionTest, InterpretArrayConcatArraysOfArrays) {
  Package package(TestBaseName());
...
TEST_P(CodegenCombinationalFunctionTest, ArrayIndexSimpleArray) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  Type* u16 = package.GetBitsType(16);
...
TEST_P(CodegenCombinationalFunctionTest, ArrayIndexWithNarrowIndex) {
...
TEST_P(CodegenCombinationalFunctionTest, ArrayIndexWithLiteralIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(4, u8));
...
TEST_P(CodegenCombinationalFunctionTest, ArrayIndexNilIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(3, u8));
...
TEST_P(CodegenCombinationalFunctionTest, ArrayIndex2DArrayIndexSingleElement) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  Type* u16 = package.GetBitsType(16);
...
TEST_P(CodegenCombinationalFunctionTest, ArrayIndex2DArrayIndexSubArray) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  Type* u16 = package.GetBitsType(16);
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdateLiteralIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(3, u8));
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdateVariableIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(3, u8));
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdate2DLiteralIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(2, package.GetArrayType(3, u8)));
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdate2DVariableIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(2, package.GetArrayType(3, u8)));
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdate2DLiteralAndVariableIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(2, package.GetArrayType(3, u8)));
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdate2DUpdateArrayLiteralIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(2, package.GetArrayType(3, u8)));
...
TEST_P(CodegenCombinationalFunctionTest,
       ArrayUpdate2DUpdateArrayVariableIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(2, package.GetArrayType(3, u8)));
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdate2DUpdateArrayNilIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", package.GetArrayType(2, package.GetArrayType(3, u8)));
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdateBitsNilIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u8 = package.GetBitsType(8);
  auto a = fb.Param("a", u8);
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdateWithDifferentTypesIndices) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
...
TEST_P(CodegenCombinationalFunctionTest, ArrayUpdateWithNarrowIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u32 = package.GetBitsType(32);
...
TEST_P(CodegenCombinationalFunctionTest, ArraySliceWithNarrowStart) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u32 = package.GetBitsType(32);
...
TEST_P(CodegenCombinationalFunctionTest, ArraySliceWithWideStart) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u32 = package.GetBitsType(32);
  BValue a = fb.Param("a", package.GetArrayType(5, u32));
...
TEST_P(CodegenCombinationalFunctionTest, ArraySliceWiderThanInputArray) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* u32 = package.GetBitsType(32);
...
TEST_P(CodegenCombinationalFunctionTest, TwoDArraySlice) {
  verilog::VerilogFile file(codegen_options().use_system_verilog()
...
TEST_P(CodegenCombinationalFunctionTest, UDiv) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
...
TEST_P(CodegenCombinationalFunctionTest, SDiv) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  BValue x = fb.Param("x", package.GetBitsType(32));
  BValue y = fb.Param("y", package.GetBitsType(32));
...
TEST_P(CodegenCombinationalFunctionTest, OneBitTupleIndex) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  BValue x = fb.Param(
      "x",
...
TEST_P(CodegenCombinationalFunctionTest, ArrayEq) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
...
TEST_P(CodegenCombinationalFunctionTest, TwoDArrayNe) {
  Package package(TestBaseName());
  FunctionBuilder fb(TestBaseName(), &package);
  Type* array_type =
...
INSTANTIATE_TEST_SUITE_P(
    CodegenCombinationalFunctionTestInstantiation,
    CodegenCombinationalFunctionTest,
    testing::ValuesIn(verilog::kDefaultSimulationTargets),
    verilog::ParameterizedTestName<CodegenCombinationalFunctionTest>);
