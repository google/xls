...
fn main(x165545: bool) -> (u57, u13, u22, u13, bool, bool, u1, u2, u13, u37) {
    ...
    let x165558: u2 = (x165549)[(u32:0x0)];
    let x165559: u2 = (x165549)[(u32:0x1)];
    let x165560: u37 = (u37:0x1fffffffff);
    let x165561: u13 = clz(x165557);
    let x165562: u2 = (x165549)[(u32:0x0)];
    ...
    let x165564: u13 = (((x165550 as s13)) >> (((u13:0x5)) if ((x165557) >= ((u13:0x5))) else (x165557))) as u13;
    let x165565: bool = (x165551)[(u32:0x0)];
    ...
    let x165576: bool = (x165551)[(u32:0x0)];
    let x165577: u2 = (x165549)[(u32:0x0)];
