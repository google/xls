...
// options: {"input_is_dslx": true, "ir_converter_args": ["--top=main"], "convert_to_ir": true, "optimize_ir": true, "use_jit": true, "codegen": true, "codegen_args": ["--use_system_verilog", "--generator=pipeline", "--pipeline_stages=7", "--reset_data_path=false"], "simulate": false, "simulator": null, "use_system_verilog": true}
// args: bits[53]:0x80
