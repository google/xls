...
// Exception:
// Command '['/xls/tools/eval_ir_main', '--input_file=args.txt', '--use_llvm_jit', 'sample.ir', '--logtostderr']' returned non-zero exit status 1.
// Issue: https://github.com/google/xls/issues/746
//
// options: {"calls_per_sample": 128, "codegen": false, "codegen_args": null, "convert_to_ir": true, "input_is_dslx": true, "ir_converter_args": ["--top=main"], "optimize_ir": true, "proc_ticks": null, "simulate": false, "simulator": null, "timeout_seconds": 600, "top_type": 0, "use_jit": true, "use_system_verilog": false}
