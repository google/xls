...
// Exception:
// Command '['xls/tools/eval_ir_main', '--input_file=args.txt', '--use_llvm_jit', 'sample.opt.ir', '--logtostderr']' timed out after 1500 seconds
// Issue: https://github.com/google/xls/issues/929
//
// options: {"calls_per_sample": 128, "codegen": true, "codegen_args": ["--nouse_system_verilog", "--generator=pipeline", "--pipeline_stages=8", "--reset=rst", "--reset_active_low=false", "--reset_asynchronous=false", "--reset_data_path=false"], "convert_to_ir": true, "input_is_dslx": true, "ir_converter_args": ["--top=main"], "optimize_ir": true, "proc_ticks": 0, "simulate": true, "simulator": "iverilog", "timeout_seconds": 1500, "top_type": 0, "use_jit": true, "use_system_verilog": false}
