...
fn main() -> u8[12] {
  ...
  let char_escape:u8 = '\x5f';  // underscore
  [newline, carriage_return, tab, backslash, null, single_quote, double_quote,
   random_char, random_char_deduced_type, dash, dash_deduced_type, char_escape]
}
