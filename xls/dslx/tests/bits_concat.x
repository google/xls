...
fn binop(x: u2, y: u6) -> u8 { x ++ y }

fn binop_chain(x: u1, y: u2, z: u3) -> u6 { x ++ y ++ z }

fn binop_parametric<M: u32, N: u32, R: u32 = {M + N}>(x: bits[M], y: bits[N]) -> bits[R] { x ++ y }

#[test]
fn test_main() {
    assert_eq(u8:0b11000000, binop(u2:0b11, u6:0));
    assert_eq(u8:0b00000111, binop(u2:0, u6:0b111));
