...
fn make_u32_array<N: u32>() -> u32[N] {
  zero!<u32[N]>()
}

fn u32_array_size<N: u32>() -> u32 {
  array_size(make_u32_array<N>())
}
...
fn make_s32_array<N: u32>() -> s32[N] {
  zero!<s32[N]>()
}

fn s32_array_size<N: u32>() -> u32 {
  array_size(make_s32_array<N>())
}
...
fn tuple_array_size<N: u32>(x: (u32, u64)[N]) -> u32 {
  array_size(x)
}
