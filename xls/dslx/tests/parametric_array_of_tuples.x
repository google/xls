...
fn f_tuple_as_type_alias<N: u32>(xs: MyTuple[N]) -> u32 { N }
...
fn f_tuple_as_type_annotation<N: u32>(xs: (u8)[N]) -> u32 { N }
...
fn main() -> u32 { main_tuple_as_type_annotation() + main_tuple_as_type_alias() }
