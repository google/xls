...
TEST_P(Bfloat16CmpTest, ExhaustiveVsInterestingValues) {
  ...
  auto do_test = [&](uint16_t u16_a, uint16_t u16_b) {
    ...
    XLS_ASSERT_OK_AND_ASSIGN(Value xls_value,
                             std::visit(
                                 [&](auto& jit) {
...
INSTANTIATE_TEST_SUITE_P(Bfloat16CmpTests, Bfloat16CmpTest,
                         ::testing::Values(CmpOp::kEq, CmpOp::kGt, CmpOp::kGte,
                                           CmpOp::kLt, CmpOp::kLte),
