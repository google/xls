fn main(x0: u48, x1: s18, x2: u10, x3: u63, x4: u44, x5: u20, x6: u61) -> bool {
  ...
  ;
    ...
    let x14: (u1,) = (x13,);
    let x15: uN[0x2] = one_hot(x13, (u1:0x1));
    let x16: uN[0x3e] = one_hot(x8, (u1:0x0));
    let x17: bool = (x13) <= ((x15 as u1));
    let x18: s39 = (s39:0x400000000);
    let x19: u1 = xor_reduce(x6);
    let x20: uN[0x3e] = (x6) ++ (x19);
    let x21: u33 = (u33:0x100000000);
    let x22: uN[0x2] = one_hot_sel(x17, [x15]);
    let x23: u1 = (x14)[(u32:0x0)];
    let x24: uN[0x1] = (x9)[-0x2:];
    let x25: (u1,) = (x13,);
