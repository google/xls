type x24 = uN[0x9];fn main(x0: u48, x1: s18, x2: u10, x3: u63, x4: u44, x5: u20, x6: u61) -> (u61, s6, u12, u61, u20, u20, u10, u61, u61, u20, u44, u61, s6, u44, u44, u10, u61, s6, u58, x24[0x1], u61, x24[0x1]) {
    let x7: u58 = (x2) ++ (x0);
    let x8: u61 = clz(x6);
    let x9: u9 = (x5)[0xb+:u9];
    let x10: u61 = x8;
