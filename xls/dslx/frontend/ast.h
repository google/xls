...
class Function : public AstNode {
 public:
  ...
  // For a lambda function, returns the parametrics that can be ignored when
  // they can't be implicitly inferred.
  absl::flat_hash_set<const ParametricBinding*>
  LambdaInferenceIgnorableParametrics() const;
  // For a lambda function, returns parametric that defines an implicit return
  // type.
  std::optional<const ParametricBinding*> LambdaReturnTypeParametric() const;
