...
class StructDefBase : public AstNode {
 public:
  ...
  bool is_derived_domain_struct() const { return is_derived_domain_struct_; }
  void set_is_derived_domain_struct(bool v) { is_derived_domain_struct_ = v; }
 ...
 private:
  ...
  bool public_;
  std::optional<Impl*> impl_;
  bool is_derived_domain_struct_ = false;
};
