...
TEST(TypecheckV2StructTest, FuzzTestStructDomainOmittedFieldsOk) {
  EXPECT_THAT(
      R"(
struct S { x: u32, y: u8 }
...
TEST(TypecheckV2StructTest, FuzzTestDerivedStructDomainTwoFieldsSuccess) {
  EXPECT_THAT(R"(
#[fuzz_domain("MyStructDomain")]
struct MyStruct {
    x: u32,
...
TEST(TypecheckV2StructTest, FuzzTestDerivedStructDomainFieldMismatch) {
  EXPECT_THAT(R"(
#[fuzz_domain("MyStructDomain")]
struct MyStruct {
    x: u32,
...
TEST(TypecheckV2StructTest, FuzzTestDerivedStructDomainFieldMissingOk) {
  EXPECT_THAT(
      R"(
#[fuzz_domain("MyStructDomain")]
struct MyStruct {
...
TEST(TypecheckV2StructTest, FuzzTestDerivedStructDomainExtraField) {
  EXPECT_THAT(R"(
#[fuzz_domain("MyStructDomain")]
struct MyStruct {
    x: u32,
...
TEST(TypecheckV2StructTest, FuzzTestDerivedStructDomainValueMismatch) {
  EXPECT_THAT(R"(
#[fuzz_domain("MyStructDomain")]
struct MyStruct {
    x: u8,
...
TEST(TypecheckV2StructTest, FuzzTestDerivedStructDomainStructVsRangeMismatch) {
  EXPECT_THAT(
      R"(
#[fuzz_domain("InnerDomain")]
struct Inner {
...
TEST(TypecheckV2StructTest, FuzzTestDerivedStructDomainRangeVsStructMismatch) {
  EXPECT_THAT(R"(
#[fuzz_domain("InnerDomain")]
struct Inner {
    y: u32,
...
TEST(TypecheckV2StructTest, FuzzTestSignedRangeOverflow) {
  EXPECT_THAT(
      R"(
...
TEST(TypecheckV2StructTest, FuzzTestTupleDomainParamNonTuple) {
  EXPECT_THAT(
      R"(
...
TEST(TypecheckV2StructTest, FuzzTestTupleDomainSizeMismatch) {
  EXPECT_THAT(
      R"(
...
TEST(TypecheckV2StructTest, FuzzTestStructDomainParamNonStruct) {
  EXPECT_THAT(R"(
#[fuzz_domain("MyStructDomain")]
struct MyStruct {
    x: u32,
...
TEST(TypecheckV2StructTest, FuzzTestUnsupportedDomainType) {
  EXPECT_THAT(
      R"(
const C = u32:42;
#[fuzz_test(domains=`C`)]
...
TEST(TypecheckV2StructTest, FuzzTestImportedRangeDomainTypeMismatch) {
  constexpr std::string_view kImported = R"(
...
TEST(TypecheckV2StructTest, FuzzTestImportedTupleDomainParamNonTuple) {
  constexpr std::string_view kImported = R"(
...
TEST(TypecheckV2StructTest, FuzzTestImportedTupleDomainSizeMismatch) {
  constexpr std::string_view kImported = R"(
    pub const DOMAIN = (u32:0..10, u32:0..10);
  )";
  constexpr std::string_view kProgram = R"(
...
TEST(TypecheckV2StructTest, FuzzTestImportedStructDomainParamNonStruct) {
  constexpr std::string_view kImported = R"(
    #[fuzz_domain("SDomain")]
    pub struct S { x: u32 }
...
TEST(TypecheckV2StructTest, FuzzTestImportedStructDomainSizeMismatch) {
  constexpr std::string_view kImported = R"(
    #[fuzz_domain("SDomain")]
    pub struct S { x: u32 }
    pub const DOMAIN = SDomain { x: u32:0..10 };
...
TEST(TypecheckV2StructTest, FuzzTestSignedRangeNegativeForUnsignedParam) {
  EXPECT_THAT(
      R"(
...
TEST(TypecheckV2StructTest, FuzzTestSignedRangePositiveForUnsignedParam) {
  EXPECT_THAT(
      R"(
...
TEST(TypecheckV2StructTest, FuzzTestUnsignedRangeOverflowForSignedParam) {
  EXPECT_THAT(
      R"(
...
TEST(TypecheckV2StructTest, FuzzTestUnsignedRangeForSignedParam) {
  EXPECT_THAT(
      R"(
...
TEST(TypecheckV2StructTest, FuzzTestEmptyDomainFunctionDoesNotCrash) {
  EXPECT_THAT(
      R"(
#[fuzz_domain("SDomain")]
struct S { x: u8 }
...
TEST(TypecheckV2StructTest, FuzzTestDomainLocalVariableCaught) {
  EXPECT_THAT(
      R"(
#[fuzz_domain("SDomain")]
struct S { x: u8 }
...
TEST(TypecheckV2StructTest, FuzzTestDomainNestedFunctionCaught) {
  EXPECT_THAT(
      R"(
#[fuzz_domain("SDomain")]
struct S { x: u8 }
...
TEST(TypecheckV2StructTest, FuzzTestDomainImportedCaught) {
  constexpr std::string_view kImported = R"(
    #[fuzz_domain("SDomain")]
    pub struct S { x: u8 }
