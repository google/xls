...
class SumType : public Type {
 public:
  ...
  // kUnspecified means no evaluation result was supplied; kNoZeroVariant means
  ...
  // requires an evaluated result; kUnspecified is insufficient.
  using ZeroSelection = std::variant<ZeroSelectionState,
  ...
  SumType(const SumDef& sum_def, std::vector<SumTypeVariant> variants,
          ZeroSelection zero_selection = ZeroSelectionState::kUnspecified)
      : sum_def_(sum_def),
