...
PYBIND11_MODULE(function_builder, m) {
  ...
  BValue (FunctionBuilder::*add_literal_value)(
      Value, absl::optional<SourceLocation>, absl::string_view) =
      &FunctionBuilder::Literal;
  BValue (FunctionBuilder::*add_sel)(
      BValue, BValue, BValue, absl::optional<SourceLocation>,
      absl::string_view) = &FunctionBuilder::Select;
  BValue (FunctionBuilder::*add_sel_multi)(
      BValue, absl::Span<const BValue>, absl::optional<BValue>,
      absl::optional<SourceLocation>, absl::string_view) =
