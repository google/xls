...
class OpOverrideAssignment {
 public:
  ...
  std::string_view assignment_format_string() const {
    return assignment_format_string_;
  }

  const absl::flat_hash_map<std::string, std::string>& placeholder_aliases()
      const {
    return placeholder_aliases_;
  }
...
class OpOverrideAssertion {
 public:
  explicit OpOverrideAssertion(std::string_view fmt_string)
      : assertion_format_string_(fmt_string) {}

  std::string_view assertion_format_string() const {
    return assertion_format_string_;
  }
...
//    );
class OpOverrideInstantiation {
 public:
  explicit OpOverrideInstantiation(std::string_view fmt_string)
      : instantiation_format_string_(fmt_string) {}

  std::string_view instantiation_format_string() const {
    return instantiation_format_string_;
  }
...
using OpOverride = std::variant<OpOverrideAssignment, OpOverrideGateAssignment,
                                OpOverrideAssertion, OpOverrideInstantiation>;
