...
TEST_P(ModuleBuilderTest, DynamicBitSliceAsFunction) {
  ...
  BValue dyn_slice_x_y_5 = fb.DynamicBitSlice(
      fb.Param("x", u32), fb.Param("y", u32), 5);
  BValue dyn_slice_y_z_5 = fb.DynamicBitSlice(
      fb.Param("y", u32), fb.Param("z", u32), 5);
  BValue dyn_slice_w_z_10 = fb.DynamicBitSlice(
      fb.Param("w", u16), fb.Param("z", u32), 10);
  ...
  XLS_ASSERT_OK(
      mb.EmitAsAssignment(
          "dyn_slice_x_y_5", dyn_slice_x_y_5.node(), {x, y}).status());
  XLS_ASSERT_OK(
      mb.EmitAsAssignment(
          "dyn_slice_y_z_5", dyn_slice_y_z_5.node(), {y, z}).status());
  XLS_ASSERT_OK(
      mb.EmitAsAssignment(
          "dyn_slice_w_z_10", dyn_slice_w_z_10.node(), {w, z}).status());
