...
#ifndef XLS_CODEGEN_SIGNATURE_GENERATION_PASS_H_
#define XLS_CODEGEN_SIGNATURE_GENERATION_PASS_H_
...
class SignatureGenerationPass : public CodegenPass {
 public:
...
#endif  // XLS_CODEGEN_SIGNATURE_GENERATION_PASS_H_
