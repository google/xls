...
fn run_a_test() {
    // @21
    let (pc, rd, ra, rm, wm) = run_a_instruction(u16:0, u16:0b0_000000000010101, u16:1, u16:2, u16:3);
...
fn run_c_test() {
    // MD=D+1
    let (pc, rd, ra, rm, wm) = run_c_instruction(u16:0, u16:0b111_0011111_011_000, u16:1, u16:2, u16:3);
    let _ = assert_eq(pc, u16:1);
    let _ = assert_eq(rd, u16:2);
    let _ = assert_eq(ra, u16:2);
    let _ = assert_eq(rm, u16:2);
    // D+1;JLE
    let (pc, rd, ra, rm, wm) = run_c_instruction(u16:0, u16:0b111_0011111_000_110, s16:-1 as u16, u16:2, u16:3);
    let _ = assert_eq(pc, u16:2);
    let _ = assert_eq(rd, s16:-1 as u16);
    let _ = assert_eq(ra, u16:2);
    let _ = assert_eq(rm, u16:3);
    // 0;JMP
    let (pc, rd, ra, rm, wm) = run_c_instruction(u16:0, u16:0b111_0101010_000_111, u16:1, u16:2, u16:3);
    let _ = assert_eq(pc, u16:2);
    let _ = assert_eq(rd, u16:1);
    let _ = assert_eq(ra, u16:2);
    let _ = assert_eq(rm, u16:3);
...
fn run_cpu() {
    let rom = u16[32]:[
        u16:0b0_000000000010000,   // 00 @16
        u16:0b111_0111111_001_000, // 01 M=1
        u16:0b0_000000000010001,   // 02 @17
        u16:0b111_0101010_001_000, // 03 M=0
        u16:0b0_000000000010000,   // 04 @16
        u16:0b111_1110000_010_000, // 05 D=M
        u16:0b0_000000000000000,   // 06 @0
        u16:0b111_1000111_010_000, // 07 D=M-D
        u16:0b0_000000000010010,   // 08 @18
        u16:0b111_0001100_000_100, // 09 D;JLT
        u16:0b0_000000000010000,   // 10 @16
        u16:0b111_1110000_010_000, // 11 D=M
        u16:0b0_000000000010001,   // 12 @17
        u16:0b111_1000010_001_000, // 13 M=D+M
        u16:0b0_000000000010000,   // 14 @16
        u16:0b111_1110111_001_000, // 15 M=M+1
        u16:0b0_000000000000100,   // 16 @4
        u16:0b111_0101010_000_111, // 17 0;JMP
        u16:0b0_000000000010001,   // 18 @17
        u16:0b111_1110000_010_000, // 19 D=M
        u16:0b0_000000000000001,   // 20 @1
        u16:0b111_0001100_001_000, // 21 M=D
        u16:0b0_000000000010110,   // 22 @22
        u16:0b111_0101010_000_111, // 23 0;JMP
        u16:0, ...
    ];
    let pc = u16:0;
    let ra = u16:0;
