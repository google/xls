...
fn idct_row(s: s32[8]) -> s32[8] {
  ...
  let w3pw5 = W3 + W5;
  let w3mw5 = W3 - W5;
  let x0 = (s[u8:0] << s32:11) + s32:128;
  let x1 = s[u8:4] << s32:11;
  let x2 = s[u8:6];
  let x3 = s[u8:2];
  let x4 = s[u8:1];
  let x5 = s[u8:7];
  ...
  let x3 = x0 + x2;
  let x0 = x0 - x2;
  let x2 = (R2 * (x4 + x5) + s32:128) >>> s32:8;
  let x4 = (R2 * (x4 - x5) + s32:128) >>> s32:8;
...
fn idct_col(s: s32[8]) -> s32[8] {
  ...
  let y4 = (y8 + w1mw7 * y4) >>> s32:3;
  let y5 = (y8 - w1pw7 * y5) >>> s32:3;
  let y8 = W3 * (y6 + y7) + s32:4;
  let y6 = (y8 - w3mw5 * y6) >>> s32:3;
  let y7 = (y8 - w3pw5 * y7) >>> s32:3;

  // Stage 2.
  let y8 = y0 + y1;
  let y0 = y0 - y1;
  let y1 = W6 * (y3 + y2) + s32:4;
  let y2 = (y1 - w2pw6 * y2) >>> s32:3;
  let y3 = (y1 + w2mw6 * y3) >>> s32:3;
  let y1 = y4 + y6;
  let y4 = y4 - y6;
  let y6 = y5 + y7;
  let y5 = y5 - y7;
  ...
  let y3 = y0 + y2;
  let y0 = y0 - y2;
  let y2 = (R2 * (y4 + y5) + s32:128) >>> s32:8;
  let y4 = (R2 * (y4 - y5) + s32:128) >>> s32:8;
