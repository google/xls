...
#ifndef XLS_NOC_CONFIG_BIDIRECTIONAL_BUTTERFLY_OPTIONS_PROTO_BUILDER_H_
#define XLS_NOC_CONFIG_BIDIRECTIONAL_BUTTERFLY_OPTIONS_PROTO_BUILDER_H_
...
#endif  // XLS_NOC_CONFIG_BIDIRECTIONAL_BUTTERFLY_OPTIONS_PROTO_BUILDER_H_
