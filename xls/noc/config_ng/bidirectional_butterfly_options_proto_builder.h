...
#ifndef XLS_NOC_CONFIG_NG_BIDIRECTIONAL_BUTTERFLY_OPTIONS_PROTO_BUILDER_H_
#define XLS_NOC_CONFIG_NG_BIDIRECTIONAL_BUTTERFLY_OPTIONS_PROTO_BUILDER_H_

#include "xls/noc/config_ng/topology_options_network_config_builder.pb.h"

namespace xls::noc {

// A builder to aid in constructing a bidirectional butterfly options proto.
class BidirectionalButterflyOptionsProtoBuilder {
 public:
  ...
  explicit BidirectionalButterflyOptionsProtoBuilder(
  ...
  // Sets the endpoint connection location of the bidirectional butterfly
  // options.
  ...
  // Sets the endpoint connection location of the bidirectional butterfly
  // options to first stage.
  BidirectionalButterflyOptionsProtoBuilder&
  SetEndpointConnectionToConnectToFirstStage();

  // Sets the endpoint connection location of the bidirectional butterfly
  // options to last stage.
  BidirectionalButterflyOptionsProtoBuilder&
  SetEndpointConnectionToConnectToLastStage();

 private:
  BidirectionalButterflyOptionsProto* proto_ptr_;
};

}  // namespace xls::noc

#endif  // XLS_NOC_CONFIG_NG_BIDIRECTIONAL_BUTTERFLY_OPTIONS_PROTO_BUILDER_H_
