...
#ifndef XLS_NOC_CONFIG_NETWORK_TOPOLOGY_COMPONENT_H_
#define XLS_NOC_CONFIG_NETWORK_TOPOLOGY_COMPONENT_H_
...
#endif  // XLS_NOC_CONFIG_NETWORK_TOPOLOGY_COMPONENT_H_
