...
#ifndef XLS_NOC_CONFIG_NETWORK_COMPONENT_PORT_UTILS_H_
#define XLS_NOC_CONFIG_NETWORK_COMPONENT_PORT_UTILS_H_
...
#endif  // XLS_NOC_CONFIG_NETWORK_COMPONENT_PORT_UTILS_H_
