...
#ifndef XLS_NOC_CONFIG_DIMENSION_ORDER_ENTRY_OPTIONS_PROTO_BUILDER_H_
#define XLS_NOC_CONFIG_DIMENSION_ORDER_ENTRY_OPTIONS_PROTO_BUILDER_H_
...
#endif  // XLS_NOC_CONFIG_DIMENSION_ORDER_ENTRY_OPTIONS_PROTO_BUILDER_H_
