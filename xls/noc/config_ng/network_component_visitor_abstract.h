...
#ifndef XLS_NOC_CONFIG_NETWORK_COMPONENT_VISITOR_ABSTRACT_H_
#define XLS_NOC_CONFIG_NETWORK_COMPONENT_VISITOR_ABSTRACT_H_
...
#endif  // XLS_NOC_CONFIG_NETWORK_COMPONENT_VISITOR_ABSTRACT_H_
