...
entry function `main`. This can be generated by
`dev_tools:dump_llvm_artifacts_main`. See the description in the
[tools page](tools.md#jit-inspection) for how these flags work.
